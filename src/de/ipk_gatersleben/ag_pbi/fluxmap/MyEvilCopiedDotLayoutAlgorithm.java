...
/**
 * this is a copied version of the dot-layouter from vanted, which has a small bug in v2.0:
 * - in windows the program files folder gets an (x86) added on a 64bit machine
 * -> dolayout could not be found
 * here we corrected the layouter for this addon. uargs. after the release of v2.1 we can get rid of this...
 */
public class MyEvilCopiedDotLayoutAlgorithm extends AbstractAlgorithm {
	...
	public MyEvilCopiedDotLayoutAlgorithm() {
		super();
	}
